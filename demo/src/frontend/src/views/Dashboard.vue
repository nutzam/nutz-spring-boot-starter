    ...
    <a-row :gutter="24">
      <a-col :sm="24" :md="12" :xl="6" :style="{marginBottom: '24px'}">
        <chart-card :loading="loading" title="总销售额" total="￥126,560">
          ...
          <div>
            <trend flag="up" style="margin-right: 16px;" :percentage="12">
...
export default class Dashboard extends Mixins(DeviceMixin) {
  ...
  public barData2: Array<any> = [];
  public rankList: Array<any> = [];
  public searchUserData: Array<any> = [];
  public searchData: Array<any> = [];
  public pieData: any;
  public searchUserScale: Array<any> = [
    {
      dataKey: 'x',
      alias: '时间',
    },
  ...
  public searchTableColumns: Array<any> = [
    {
      dataIndex: 'index',
      title: '排名',
      width: 90,
